    ...
    <div v-if="isDesktop" class="flex h-screen overflow-hidden">
      ...
      <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <div class="flex-1 overflow-y-auto px-10 pt-6 pb-8">
          <button
            @click="router.back()"
            class="text-[#2E42B2] font-semibold text-xl flex items-center gap-2 hover:opacity-70 cursor-pointer mb-6"
          >
          ...
          <template v-else>
            <div class="flex flex-col gap-6">
              ...
              <div
                id="ticket-printable"
                class="w-full rounded-[6.85px] bg-[#f9fafb] border border-[#2e42b2] flex flex-col gap-4 p-6"
              >
                <!-- Nama + Badge -->
                ...
                <div class="flex gap-5 flex-wrap">
                  <div class="flex-1 min-w-[160px] flex flex-col gap-2">
                    ...
                    <div
                      class="h-14 rounded-[9px] bg-[#dee8fb] border border-[#2e42b2] flex items-center gap-3 px-4"
                    >
                  ...
                  <div class="flex-1 min-w-[160px] flex flex-col gap-2">
                    ...
                    >
                      ...
                      <span class="text-base font-medium text-[#2e42b2]">{{
                        ticket.jenis_burung
                      }}</span>
                    </div>
                  </div>
                ...
                <div
                  class="rounded-[9px] bg-[#dee8fb] border border-[#2e42b2] w-full p-5 flex flex-col items-center gap-3"
                >
                  <span class="w-full text-xl font-semibold text-[#2e42b2]"
                    >Blok dipilih: {{ ticket.blok ?? '-' }}</span
                  >
                  <span class="w-full text-xl font-semibold text-[#2e42b2]">Nomor Gantangan:</span>
                  <div
                    class="rounded-[8px] bg-[#265bda] w-[110px] h-[110px] flex items-center justify-center"
                  >
                    <b class="text-[40px] leading-[48px] text-[#f9fafb]">{{
                      ticket.nomor_gantangan ?? '-'
                    }}</b>
                  </div>
                </div>
              </div>
      ...
      <main class="flex-1 overflow-y-auto">
        <div class="max-w-md mx-auto px-5 py-5 flex flex-col items-center gap-5">
          <div class="w-full">
            <button
              @click="router.back()"
              class="text-[#2E42B2] font-semibold text-[18px] flex items-center gap-2 hover:opacity-70 cursor-pointer"
            >
          ...
          <div
            v-else-if="!ticket"
            class="flex flex-col items-center justify-center py-24 gap-4 w-full"
          >
            <img src="@/assets/empty-box.svg" alt="Tidak ada tiket" class="w-[150px] h-[150px]" />
          ...
          <template v-else>
            <div
              id="ticket-printable"
              class="self-stretch rounded-[6.85px] bg-[#f9fafb] border border-[#2e42b2] flex flex-col gap-[10px] p-[10px]"
            >
              <!-- Nama + Badge -->
              <div class="flex items-center justify-between gap-3 flex-wrap">
                <b class="text-[22px] leading-[28px] text-[#2e42b2] flex-1">{{
                  ticket.nama_lomba
                }}</b>
              ...
              <div class="flex gap-4 flex-wrap">
                <div class="flex-1 min-w-[120px] flex flex-col gap-[6px]">
                  ...
                  <div
                    class="h-11 rounded-[9px] bg-[#dee8fb] border border-[#2e42b2] flex items-center gap-2 px-3"
                  >
                ...
                <div class="flex-1 min-w-[120px] flex flex-col gap-[6px]">
                  ...
                  >
                    ...
                    <span class="text-sm font-medium text-[#2e42b2]">{{
                      ticket.jenis_burung
                    }}</span>
                  </div>
                </div>
              ...
              <!-- Blok + Nomor Gantangan -->
              <div
                class="rounded-[9px] bg-[#dee8fb] border border-[#2e42b2] p-4 flex flex-col items-center gap-2"
              >
                <span class="w-full text-base font-semibold text-[#2e42b2]"
                  >Blok dipilih: {{ ticket.blok ?? '-' }}</span
                >
                <span class="w-full text-base font-semibold text-[#2e42b2]">Nomor Gantangan:</span>
                <div
                  class="rounded-[8px] bg-[#265bda] w-[90px] h-[90px] flex items-center justify-center"
                >
                  <b class="text-[32px] leading-[38px] text-[#f9fafb]">{{
                    ticket.nomor_gantangan ?? '-'
                  }}</b>
                </div>
              </div>
