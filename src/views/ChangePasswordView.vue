    ...
    <div class="right-panel">
      <div class="form">
        ...
        <div class="field-group">
          ...
          <PasswordInput v-model="form.newPassword" placeholder="Password" autocomplete="new-password" />
        </div>
        ...
        <button class="btn-submit" @click="handleChangePassword" :disabled="authStore.loading">
