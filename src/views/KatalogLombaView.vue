...
<template>
    ...
    <div class="flex-1 flex flex-col overflow-hidden w-full">
      ...
      <div class="flex-1 overflow-y-auto px-4 md:px-10 pt-4 md:pt-6 pb-8 md:pb-8 w-full">
        ...
        <div class="md:hidden flex gap-3 mb-6">
          ...
          <button @click="openFilter" class="p-3 rounded-xl border-2 border-[#E8EDF5] text-[#2E42B2] active:bg-[#E8EDF5] shrink-0">
        ...
        <!-- Lomba List -->
        <!-- Desktop List -->
        <div v-else class="hidden md:flex flex-col gap-4">
          <div
  ...
  <transition name="fade">
    <div v-if="isMobileSidebarOpen" @click="closeMobileSidebar" class="fixed inset-0 bg-black/40 z-50 md:hidden"></div>
  </transition>

  <!-- Mobile Sidebar -->
  <transition name="slide-right">
    <div v-if="isMobileSidebarOpen" class="fixed left-0 top-0 h-screen w-64 bg-[#314EAE] z-50 md:hidden overflow-y-auto shadow-xl">
  ...
  <transition name="slide-up">
    <div v-if="isFilterOpen" class="fixed inset-x-0 bottom-0 z-[60] bg-white rounded-t-3xl shadow-[0_-5px_20px_rgba(0,0,0,0.1)] p-6 max-h-[90vh] overflow-y-auto md:hidden">
