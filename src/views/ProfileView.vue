<template>
  <div class="min-h-screen bg-[#F4F7FE] font-plus-jakarta flex flex-col">
          ...
          <div v-else class="w-full bg-white p-8 rounded-xl shadow-sm border border-gray-100">
            ...
            <div class="space-y-5">
              <div class="flex flex-col gap-1">
                ...
                <div
                  class="w-full bg-[#6D9BED] border border-[#2D48C8] rounded-lg px-4 py-2.5 shadow-sm"
                >
              ...
              <div class="flex flex-col gap-1">
                ...
                <div
                  class="w-full bg-[#DEE8FB] border border-[#2D48C8] rounded-lg px-4 py-2.5 text-[#1C244F] font-semibold text-base"
                >
                  {{ profile.fullName }}
                </div>
              </div>
              ...
              <div class="flex flex-col gap-1">
                ...
                <div
                  class="w-full bg-[#DEE8FB] border border-[#2D48C8] rounded-lg px-4 py-2.5 text-[#1C244F] font-semibold text-base uppercase"
                >
    ...
    <div v-else class="flex flex-col min-h-screen bg-white">
      <HeaderMobile title="Profil Akun" @menu-click="isSidebarOpen = true" />
      ...
      <main class="p-8 pb-12 flex-1">
        ...
        <div v-else class="space-y-4">
          ...
          <div class="flex flex-col gap-1">
            ...
            <div
              class="w-full bg-[#DEE8FB] border border-[#2D48C8] rounded-lg px-4 py-2 text-[#1C244F] font-semibold text-sm"
            >
              {{ profile.fullName }}
            </div>
          </div>
          ...
          <div class="flex flex-col gap-1">
            ...
            <div
              class="w-full bg-[#DEE8FB] border border-[#2D48C8] rounded-lg px-4 py-2 text-[#1C244F] font-semibold text-sm uppercase"
            >
              {{ formatRole(profile.role) }}
            </div>
          </div>
