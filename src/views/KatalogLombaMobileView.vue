...
<template>
  <div class="w-full min-h-screen bg-white flex flex-col font-plus-jakarta pb-20">
    <!-- Header -->
    <header
      class="bg-[#2E42B2] text-white px-4 py-5 flex items-center justify-between sticky top-0 z-40 shadow-md"
    >
    ...
    <main class="flex-1 p-4">
      ...
      <div class="flex gap-3 mb-6">
        ...
        <button
          @click="openFilter"
          class="p-3 rounded-xl border-2 border-[#E8EDF5] text-[#2E42B2] active:bg-[#E8EDF5]"
        >
          <svg
            width="24"
            height="24"
      ...
      <div v-if="loading" class="flex justify-center py-10">
        <div
          class="animate-spin rounded-full h-8 w-8 border-4 border-[#2E42B2] border-t-transparent"
        ></div>
      </div>

      <!-- Lomba List -->
      <div
        v-else-if="filteredLombaList.length === 0"
        ...
        >
          <div class="p-4">
            <div class="flex justify-between items-start mb-1">
              ...
              <span
                :class="getStatusBadge(lomba.status)"
    ...
    <transition name="slide-up">
      <div
        v-if="isFilterOpen"
        class="fixed inset-x-0 bottom-0 z-[60] bg-white rounded-t-3xl shadow-[0_-5px_20px_rgba(0,0,0,0.1)] p-6 max-h-[90vh] overflow-y-auto"
      >
        ...
        <div class="mb-10">
          ...
          <div class="flex gap-2">
            <button
              @click="tempSort = 'asc'"
              :class="
                tempSort === 'asc' ? 'bg-[#2E42B2] text-white' : 'bg-[#E8EDF5] text-[#2E42B2]'
              "
            ...
            <button
              @click="tempSort = 'desc'"
              :class="
                tempSort === 'desc' ? 'bg-[#2E42B2] text-white' : 'bg-[#E8EDF5] text-[#2E42B2]'
              "
              class="px-6 py-2 rounded-xl text-xs font-semibold"
            >
              Terjauh
