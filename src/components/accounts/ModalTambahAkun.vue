<template>
  <div class="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/80 backdrop-sm">
    <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
      ...
      <form @submit.prevent="submitForm">
        <div class="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              type="text"
              class="w-full border rounded-lg px-3 py-2 focus:outline-blue-500"
          ...
          <div>
            ...
            <div class="relative">
              <select
                v-model="form.role"
                class="w-full border rounded-lg px-3 py-2 focus:outline-blue-500 appearance-none"
                required
              >
              ...
              <div
                class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3 text-gray-600"
              >
        ...
        <button
          type="submit"
          class="w-full bg-blue-700 text-white font-bold py-3 rounded-lg mt-8 hover:bg-blue-800 transition shadow-md cursor-pointer"
        >
          Simpan
        </button>
      </form>
  ...
  <ResetSuccessModal :show="showResetSuccess" @close="showResetSuccess = false" />
