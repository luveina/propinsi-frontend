<template>
  <form @submit.prevent="submitForm" class="space-y-5 font-plus-jakarta">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div>
        <label class="block text-sm font-semibold mb-2 text-[#1E3A8A]"
          >Nama Lomba <span class="text-red-500">*</span></label
        >
        <input
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div>
        <label class="block text-sm font-semibold mb-2 text-[#1E3A8A]"
          >Tanggal - Waktu <span class="text-red-500">*</span></label
        >
        <input
      ...
      <div>
        <label class="block text-sm font-semibold mb-2 text-[#1E3A8A]"
          >Jenis Burung <span class="text-red-500">*</span></label
        >
        <div class="relative">
          <select
          ...
          <svg
            class="w-4 h-4 absolute right-3 top-3.5 text-[#2D48C8] pointer-events-none"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div>
        <label class="block text-sm font-semibold mb-2 text-[#1E3A8A]"
          >Harga Tiket <span class="text-red-500">*</span></label
        >
        <input
    ...
    <div>
      <label class="block text-sm font-semibold mb-2 text-[#1E3A8A]"
        >Deskripsi Lomba <span class="text-red-500">*</span></label
      >
      <textarea
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div v-for="juriIndex in 4" :key="juriIndex">
        <label class="block text-sm font-semibold mb-2 text-[#1E3A8A]"
          >Juri {{ juriIndex }} <span class="text-red-500">*</span></label
        >
        <div class="relative">
          <select
          ...
          >
            ...
            <option
              ...
              :value="juri.id"
              :disabled="
                selectedJuriIds.includes(juri.id) && selectedJuriIds[juriIndex - 1] !== juri.id
              "
            >
              {{ juri.fullName }}
            </option>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div class="flex gap-4">
        <div class="w-32">
          <label class="block text-sm font-semibold mb-2 text-[#1E3A8A]"
            >Jumlah Juara <span class="text-red-500">*</span></label
          >
          <input
        ...
        <div class="flex-1">
          ...
          <div class="space-y-2">
            <div v-for="(prize, index) in form.hadiah" :key="index" class="flex items-center gap-2">
              <span class="text-xs font-semibold text-[#1E3A8A] w-14 shrink-0"
                >Juara {{ index + 1 }} <span class="text-red-500">*</span></span
              >
              <input
