<template>
  <div v-if="show" class="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/80 backdrop-sm p-4">
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-sm p-6 relative">
      <button @click="$emit('close')" class="absolute right-4 top-4 text-gray-400 hover:text-gray-600 text-2xl cursor-pointer">&times;</button>
